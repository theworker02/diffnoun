...
[![npm](https://img.shields.io/npm/v/@magnexis/diffnoun.svg)](https://www.npmjs.com/package/@magnexis/diffnoun)

Package version **1.00** (`1.0.0`). Default branch is **`main`** — never `master`.

**Docs:** [GitHub Pages](https://theworker02.github.io/diffnoun/) · **Source:** [`theworker02/diffnoun`](https://github.com/theworker02/diffnoun) · **Release 1.00:** [`v1.0.0`](https://github.com/theworker02/diffnoun/releases/tag/v1.0.0) · **npm:** [`@magnexis/diffnoun`](https://www.npmjs.com/package/@magnexis/diffnoun)
...
```bash
npm install -g @magnexis/diffnoun
diffnoun --help
```

Package page: https://www.npmjs.com/package/@magnexis/diffnoun
