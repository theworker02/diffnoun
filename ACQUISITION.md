# Acquisition Brief â€” diffnoun

**Date:** 2026-09-22  
**Repository:** https://github.com/theworker02/diffnoun  
**Default branch:** `main`  
...
This project is **proprietary**. Production use, redistribution, and commercial deployment require a written commercial license or completed acquisition. See [LICENSE](./LICENSE) and [ACQUISITION.md](./ACQUISITION.md). Contact [@theworker02](https://github.com/theworker02). <img src="docs/logo.svg" alt="diffnoun mark" width="96" height="96"> **Summarize unified diffs as structured add, remove, and change records without needing a Git repository.**

**Why a buyer cares:** diffnoun packages transferable product IP â€” source, docs, in-repo brand assets, and a diligence room under `docs/acquisition/` â€” under a clear proprietary posture so diligence can proceed without mistaking the repo for open source.
